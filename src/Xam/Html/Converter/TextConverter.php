 ...
 * HTML converter
 * 
 * Copyright 2013 Pa Essa Jabang
 * License: MIT
 *
 * Inspired by https://github.com/19ft/NFHtmlToText
 *
 *
 */

namespace Xam\Html\Converter;

use Xam\Html\ConverterException;
use Xam\Html\Document;
use DOMDocumentType;
use DOMElement;
use DOMText;
...
class TextConverter
{
    ...
    public function convert($html)
    {
        ...
        if (!$doc->loadHTML($html)) {
            throw new ConverterException("Failed to load html string");
        }
